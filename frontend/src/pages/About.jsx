...
const About = () => {
  return (
    <section className="max-w-6xl mx-auto p-4 sm:p-6 lg:p-8 bg-slate-50 dark:bg-slate-900 transition-colors duration-300">
      
      {/* --- Hero Section --- */}
      {/* A clean, white card with subtle shadows for a premium look */}
      <div className="rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-6 md:p-8 shadow-lg mb-8 transition-colors duration-300">
